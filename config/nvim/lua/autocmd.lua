...
-- 自定义快捷键
        { "i", ",f", '<Esc>/<++><CR>:nohlsearch<CR>"_c4l', { noremap = true, silent = true, buffer = true } },
        { "i", ",n", '---<Enter><Enter>', { noremap = true, silent = true, buffer = true } },
        { "i", ",b", '**** <++><Esc>F*hi', { noremap = true, silent = true, buffer = true } },
        { "i", ",s", '~~~~ <++><Esc>F~hi', { noremap = true, silent = true, buffer = true } },
        { "i", ",i", '** <++><Esc>F*i', { noremap = true, silent = true, buffer = true } },
        { "i", ",d", '`` <++><Esc>F`i', { noremap = true, silent = true, buffer = true } },
        { "i", ",c", '```<Enter><++><Enter>```<Enter><Enter><++><Esc>4kA', { noremap = true, silent = true, buffer = true } },
        { "i", ",m", '- [ ] ', { noremap = true, silent = true, buffer = true } },
        { "i", ",p", '![](<++>) <++><Esc>F[a', { noremap = true, silent = true, buffer = true } },
        { "i", ",a", '![](<++>) <++><Esc>F[a', { noremap = true, silent = true, buffer = true } },
        { "i", ",1", '#<Space><Enter><++><Esc>kA', { noremap = true, silent = true, buffer = true } },
        { "i", ",2", '##<Space><Enter><++><Esc>kA', { noremap = true, silent = true, buffer = true } },
        { "i", ",3", '###<Space><Enter><++><Esc>kA', { noremap = true, silent = true, buffer = true } },
        { "i", ",4", '####<Space><Enter><++><Esc>kA', { noremap = true, silent = true, buffer = true } },
        { "i", ",l", '--------<Enter>', { noremap = true, silent = true, buffer = true } },
    })
